...
const securityMiddleware = async (req: Request, res: Response, next: NextFunction) => {
    ...
    let message: string;
        ...
        switch (role) {
            case "admin":
                limit = 100;
                message = "Admin request limit exceeded (100 per minute). Please try again later.";
                break;
            case "teacher":
                limit = 60;
                message = "Teacher request limit exceeded (60 per minute). Please try again later.";
                break;
            case "student":
                limit = 60;
                message = "Student request limit exceeded (60 per minute). Please try again later.";
                break;
            case "guest":
                limit = 15;
                message = "Guest request limit exceeded (15 per minute). Sign in to increase your limit.";
                break;
            default:
                limit = 15;
